...
static constexpr int FOLLOW_LOST_TICKS     = 1;
static constexpr int ALIGN_LOST_TICKS      = 1;
...
static constexpr float OB_RIGHT_TRIG_CM      = 40.0f;

static constexpr int   OB_PHASE_MIN_MS       = 1000; 
static constexpr int   OB_SEEK_DURATION      = 1000;
...
static constexpr float DUTY_OB_RIGHT         = 0.65f;
